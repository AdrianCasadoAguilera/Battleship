...
public class UtilsViews {
    ...
    public static void setView(String viewId) {
        ...
        System.out.println("Current active view: " + getActiveView());
    }
    ...
    public static void setViewAnimating(String viewId) {
        ...
        if (curView == null || nxtView == null) {
            System.out.println("Error: curView or nxtView is null when trying to animate to " + viewId);
            return;
        }
